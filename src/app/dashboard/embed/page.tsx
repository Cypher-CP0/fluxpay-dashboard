      ...
      <div style={{ padding: '32px 28px' }}>
        ...
        <div style={{ marginBottom: 28 }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: 14, maxWidth: 580, lineHeight: 1.6 }}>
            ...
            Our kinetic engine handles validation, security, and real-time conversion.
          </p>
        </div>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
                <div style={{ fontSize: 11, letterSpacing: '0.1em', color: 'var(--text-muted)' }}>
                  SECURITY PROTOCOL
                </div>
                <span>🛡</span>
              </div>
              <p style={{ fontSize: 12, color: 'var(--text-secondary)', lineHeight: 1.7 }}>
                All embedded snippets are end-to-end encrypted. We never expose your private keys
                to the client-side browser environment.
              </p>
          ...
          <div style={{
            ...
            <div style={{ flex: 1, overflow: 'auto', padding: '20px 24px' }}>
              <pre style={{
                ...
                color: '#c9d1d9', margin: 0, whiteSpace: 'pre-wrap',
              }}>
                {CODE_SNIPPET.split('\n').map((line, i) => (
                  <div key={i}>
                    {line.startsWith('//') ? (
        ...
        <div style={{
          ...
          {[
            ...
            <div key={stat.label} style={{
              ...
              <div style={{ fontSize: 11, letterSpacing: '0.08em', color: 'var(--text-muted)' }}>
                {stat.sub}
              </div>
            </div>
          ))}
